...
| Condition | Détail |
|-----------|--------|
| Stake minimum | **100 VLT** (10000000000 en unités atomiques, 8 décimales) |
...
Les récompenses s'accumulent jusqu'à atteindre 100 VLT.
...
- **Deposit** : 100 VLT (10000000000 atomic) sur l'asset VLT
...
| Mineurs actifs | VLT/jour estimé (Elite) | ROI stake 100 VLT |
|----------------|------------------------|-------------------|
| 10 | ~55 VLT | < 2 jours |
| 50 | ~11 VLT | ~9 jours |
